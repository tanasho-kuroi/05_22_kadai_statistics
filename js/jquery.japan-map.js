...
(function ($) {
      ...
      prefecture.path.forEach(function (p) {
         ...
         if (this.options.movesIslands) {
            OFFSET = {
               X:
                  OFFSET.X +
                  (this.isNanseiIslands(p) ? this.NanseiIslands.left : -this.NanseiIslands.width),
   ...
   MapCanvas.prototype.drawText = function (prefecture_or_area, point) {
      var context = this.element.getContext('2d');
      var area = this.isArea(prefecture_or_area)
         ? prefecture_or_area
   ...
   MapCanvas.prototype.getCenterOfPrefecture = function (prefecture) {
      ...
      if (this.options.movesIslands) {
         OFFSET = {
            X:
               OFFSET.X +
               (this.isNanseiIslands(path) ? this.NanseiIslands.left : -this.NanseiIslands.width),
   ...
   MapCanvas.prototype.setProperties = function (prefecture, area) {
      ...
      if (pointerIsOn) {
         ...
         else if (this.options.hoverColor) context.fillStyle = this.options.hoverColor;
   ...
   var definition_of_prefectures = [
...

      {
         ...
         path: [
            ...
            {
               name: '竹島',
               coords: [303, 241, 303, 242, 302, 241, 303, 241],
            },
         ],
      },
         ...
         path: [
...

            {
               ...
               subpath: [
                  {
                     name: '魚釣島',
                     coords: [19, 533, 19, 534, 20, 533],
                  },
                  {
                     name: '久場島',
                     coords: [25, 528, 25, 529, 24, 528],
                  },
                  {
                     name: '大正島',
                     coords: [49, 528, 49, 529, 50, 528, 50, 529],
                  },
                  {
                     name: '北小島',
                     coords: [21, 534, 21, 535, 22, 534],
                  },
                  {
                     name: '南小島',
                     coords: [23, 536, 22, 536, 22, 535],
                  },
               ],
            },
         ],
