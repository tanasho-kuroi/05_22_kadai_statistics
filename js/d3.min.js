!(function () {
   ...
   function Ft(n, t, e) {
      ...
      var c = (n.utc = Ht(n));
      return (
         (c.floor = c), (c.round = Ht(r)), (c.ceil = Ht(u)), (c.offset = Ht(i)), (c.range = a), n
      );
   }
   function Ht(n) {
      return function (t, e) {
         ...
         return {
            ...
            point: function (f, h) {
               ...
               if (
                  ...
                  v !== c &&
                     ((g = r(e, p)),
                     (be(e, g) || be(p, g)) && ((p[0] += Ta), (p[1] += Ta), (v = t(p[0], p[1])))),
                  v !== c)
               )
                  (s = 0),
                     v
   ...
   function gr(n, t) {
      ...
      return function (u, i, o, a) {
         var c = o * t;
         null != u
            ? ((u = pr(e, u)), (i = pr(e, i)), (o > 0 ? i > u : u > i) && (u += o * Pa))
            : ((u = n + o * Pa), (i = n - 0.5 * c));
   ...
   function $r(n) {
      for (var t, e = tl, r = Oe(n[0][0], n[0][1], n[1][0], n[1][1]), u = e.length; u--; )
         (t = e[u]),
            (!Br(t, n) || !r(t) || (va(t.a.x - t.b.x) < Ta && va(t.a.y - t.b.y) < Ta)) &&
   ...
   function iu(n, t) {
      ...
      for (tl = [], el = new Array(n.length), rl = new nu(), il = new nu(); ; )
         if (((u = ul), i && (!u || i.y < u.y || (i.y === u.y && i.x < u.x))))
            (i.x !== e || i.y !== r) && ((el[i.i] = new Or(i)), jr(i), (e = i.x), (r = i.y)),
               (i = n.pop());
         else {
            if (!u) break;
            Ur(u.arc);
   ...
   function gu(n, t) {
      ...
      return function (n) {
         return (
            '#' + Mt(Math.round(e + i * n)) + Mt(Math.round(r + o * n)) + Mt(Math.round(u + a * n))
         );
      };
   }
   function pu(n, t) {
   ...
   function Qi(n, t) {
      ...
      return (
         ...
         (e.rangePoints = function (u, a) {
            ...
            return (
               (i = r(c + (s * a) / 2, s)), (o = 0), (t = { t: 'rangePoints', a: arguments }), e
            );
         }),
   ...
   function _o(n, t) {
      ...
      if (e) {
         var s = n[c];
         r +=
            'Q' + (i[0] + (2 * a[0]) / 3) + ',' + (i[1] + (2 * a[1]) / 3) + ',' + s[0] + ',' + s[1];
      }
      return r;
   }
   function wo(n, t) {
   ...
   function qo(n) {
      for (
         var t = 0, e = n.length - 1, r = [], u = n[0], i = n[1], o = (r[0] = zo(u, i));
         ++t < e;
   ...
   function Yo(n) {
      return function () {
         ...
         (t = this[n]) &&
            (e = t[t.active]) &&
            (--t.count ? (delete t[t.active], (t.active += 0.5)) : delete this[n],
   ...
   (ta.interpolateZoom = function (n, t) {
      ...
      (ta.behavior.zoom = function () {
         ...
         function h() {
            ...
            m ? clearTimeout(m) : ((p = t((v = d || ta.mouse(this)))), Fl.call(this), a(n)),
                     ...
                     ? ta
                          ...
                          .tween('zoom:zoom', function () {
                             ...
                             return function (t) {
                                var r = o(t),
                                   a = e / r[2];
                                (this.__chart__ = k = { x: u - r[0] * a, y: i - r[1] * a, k: a }),
                                   c(n);
                             };
                          })
   ...
   ($a.brighter = function (n) {
      return (n = Math.pow(0.7, arguments.length ? n : 1)), new ot(this.h, this.s, this.l / n);
   }),
      ($a.darker = function (n) {
         return (n = Math.pow(0.7, arguments.length ? n : 1)), new ot(this.h, this.s, n * this.l);
      }),
      ($a.rgb = function () {
   ...
   (nc.brighter = function (n) {
      ...
      return t || e || r
         ? (t && u > t && (t = u),
           e && u > e && (e = u),
           r && u > r && (r = u),
           new dt(Math.min(255, t / n), Math.min(255, e / n), Math.min(255, r / n)))
         : new dt(u, u, u);
   }),
   ...
   var jc,
      ...
      Vc = { point: Xe, lineStart: y, lineEnd: y, polygonStart: y, polygonEnd: y },
      Xc = {
         point: We,
         lineStart: Je,
         lineEnd: Ge,
   ...
   var $c,
      Bc = { sphere: y, point: y, lineStart: xr, lineEnd: y, polygonStart: y, polygonEnd: y },
      Wc = br(
         function (n) {
      ...
      (ta.geom.quadtree = function (n, t, e, r, u) {
         ...
         return (o = arguments.length)
            ...
            : ((i.x = function (n) {
              ...
              (i.size = function (n) {
                 return arguments.length
                    ? (null == n ? (t = e = r = u = null) : ((t = e = 0), (r = +n[0]), (u = +n[1])),
                      i)
                    : null == t
                    ? null
                    : [r - t, u - e];
   ...
   (ta.ease = function (n) {
      ...
      return (
         (e = hl.get(e) || fl), (r = gl.get(r) || Et), Mu(r(e.apply(null, ea.call(arguments, 1))))
      );
   }),
         ...
         function n() {
            ...
            for (h = -1; ++h < i; )
               for (g = h - 1; ++g < i; ) {
                  ...
                  (w.value || S.value) &&
                     e.push(
                        w.value < S.value ? { source: S, target: w } : { source: w, target: S }
                     );
               }
            c && t();
         }
               ...
               return (
                  e ||
                     (e = ta.behavior
                        ...
                        .on('dragend.force', $u)),
                  arguments.length
                     ? (this.on('mouseover.force', Bu).on('mouseout.force', Wu).call(e), void 0)
                     : e
               );
            }),
            ta.rebind(a, c, 'on')
            ...
            if ((p = Math.min(Math.abs(l - n) / 2, +u.apply(this, arguments))) > 0.001) {
               ...
               var T = null == S ? [_, w] : null == x ? [y, M] : Lr([y, M], [S, k], [x, b], [_, w]),
                  ...
                  j =
                     ...
                     Math.sin(
                        Math.acos(
                           (R * P + D * U) / (Math.sqrt(R * R + D * D) * Math.sqrt(P * P + U * U))
                        ) / 2
                     ),
      ...
      function n(i) {
         i.each(function () {
            ...
            c && ((s = Ui(c)), h.attr('x', s[0]).attr('width', s[1] - s[0]), e(f)),
               l && ((s = Ui(l)), h.attr('y', s[0]).attr('height', s[1] - s[0]), r(f)),
               t(f);
         });
      }
      function t(n) {
