         ...
         function r(t) {
            ...
            this.el.css('position') === 'static' && this.el.css('position', 'relative'),
               ...
               this.el.bind('mousemove', function (e) {
                  var t;
                  return (
                     (t = n.el.offset()), n.fire('hovermove', e.pageX - t.left, e.pageY - t.top)
                  );
               }),
               ...
               this.el.bind('click', function (e) {
                  var t;
                  return (
                     (t = n.el.offset()), n.fire('gridclick', e.pageX - t.left, e.pageY - t.top)
                  );
               }),
                     ...
                     this.options.axes &&
                        ...
                        (e = function () {
                           ...
                           for (
                              ...
                              n.push(
                                 this.measureText(this.data[r].text, -this.options.xLabelAngle)
                                    .height
                              );
                           return n;
                        }.call(this)),
